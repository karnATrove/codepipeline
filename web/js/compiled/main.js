...
if (window.fullScreenApi.supportsFullScreen) {
    document.getElementById('fsbutton').addEventListener('click', function() {
        window.fullScreenApi.requestFullScreen(document.getElementById('body'));
    }, true);
}
...
function initDefaultScanner() {
	...
	active_scanner = $(window).scannerListener({'element_val':'#scan','trigger':'keypress.defaultscan','delay':200});
}
