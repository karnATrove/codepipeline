...
use WarehouseBundle\Workflow\ControllerWorkflow\ProductControllerWorkflow;
...
class ProductController extends Controller
{
	...
	{
		return $this->get(ProductControllerWorkflow::class)->indexAction($request);
	}
	...
	public function newAction(Request $request)
	{
		...
		if ($form->isSubmitted() && $form->isValid()) {
			...
			if (!$existing) {
				...
				$editLink = $this->generateUrl('product_edit', ['id' => $product->getId()]);
		...
		return $this->render('WarehouseBundle::Product/new.html.twig', [
			'product' => $product,
	...
	public function editAction(Request $request, Product $product)
	{
		...
		return $this->render('WarehouseBundle::Product/edit.html.twig', [
			'product' => $product,
	...
	private function createLocationProductForm(Product $product)
	{
		...
		$form = $this->createForm('WarehouseBundle\Form\LocationProductType', $locationProduct,
			[
				'action' => $this->generateUrl('location_product_new_ajax', ['product_id' => $product->getId()]),
				'method' => 'POST',
			]
		);
