...
{	
	 ...
	 */
	public function __construct($container, BookingManagerInterface $bookingManager, RequestStack $requestStack) {
	 ...
	 */
	public function bookingIsFillable($booking) {
		$fillable_products = 0;
	 ...
	 */
	public function bookingProductQuantityTotal($booking) {
		$qty = 0;
		foreach($booking->getProducts() as $bookingProduct) {
	 ...
	 * @return     <type>  ( description_of_the_return_value )
	 */
	public function formatContactAddress($contact) {
