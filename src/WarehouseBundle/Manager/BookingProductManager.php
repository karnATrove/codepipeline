...
class BookingProductManager extends BaseManager
{
	...
	{
		parent::__construct($entityManager, BookingProduct::class);
	}
	...
	{
		return $this->entityRepository->count($bookingProductSearchModel);
	}
}